...
public class TeliaOrder {
    ...
    private List<TeliaOrderQuantities> quantities = new ArrayList<>();

    /**
     * Gets the quantities ordered.
     * @return The quantities.
     */
    public List<TeliaOrderQuantities> getQuantities() {
        return quantities;
    }
     ...
     */
    public void setQuantities(List<TeliaOrderQuantities> quantities) {
     ...
     * @param user The user.
     */
    public void setUser(TeliaUser user) {
        this.user = user;
    }
